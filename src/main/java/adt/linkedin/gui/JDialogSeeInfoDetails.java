 ...
 * @author Mario Nevado
 */
public class JDialogSeeInfoDetails extends javax.swing.JDialog {
     ...
     * @param info hace referencia a la información académica a consultar
     */
    public JDialogSeeInfoDetails(java.awt.Frame parent, boolean modal, AcademicInfo info) {
        super(parent, modal);
        initComponents();
        ...
        if(info.isCurrent()){
            ...
            this.jTextAreaEnd.setText(info.getEndDate().toString());
        }
    }
    
    /**
     * Inicializa los labels con la información de la formación académica
     */
    private void initLabels(){
        this.jTextAreaName.setText(info.getTitle());
        this.jTextAreaInstitution.setText(info.getInstitution().getName());
        this.jTextAreaMeanscore.setText(Float.toString(info.getMeanScore()));
        this.jTextAreaInit.setText(info.getInitDate().toString());
    }
