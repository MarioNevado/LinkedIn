...
public class JDialogSeeInfoDetails extends javax.swing.JDialog {
     ...
     * @param info
     */
    public JDialogSeeInfoDetails(UserService userController, User user, java.awt.Frame parent, boolean modal, AcademicInfo info) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(Utils.PURPLE);
